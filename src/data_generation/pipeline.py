...
# Iterate 20 times through deck
for iteration in range(20):
    for img_file in os.listdir(raw_img_dir):
        print(f"Processing: {img_file}, Iteration: {iteration:02d}")
        ...
        # Calculate new size for rotation (handle ±1° max, no clipping)
        ...
        out_img = f"{card_name}_{iteration:02d}.jpg"  # e.g., 7c_00.jpg, 7c_01.jpg, ..., 7c_19.jpg
        out_label = f"{card_name}_{iteration:02d}.txt"
